<?php
switch (true) {
	case is_array($category) && $category['type']=="nation":
		$cat_id_list = array();
		...
		$row_product = getItems("product", "where nation_id in ({$cat_id_list}) order by level desc, create_date desc, title", false);
