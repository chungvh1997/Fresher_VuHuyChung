<div class="well">Danh sách hình ảnh sản phẩm '<?=@$product['title']?>' (<?=$pagination->count_item?>)</div>
...
<table class="table table-striped table-bordered text-center">
	<tr>
		<td class="text-left" colspan="14">
			...
			<?php
				$backUrl=preg_replace('(&product_id=\d*)', "", str_replace("?com=product-image", "?com=product", getCurrentPageURL()));
