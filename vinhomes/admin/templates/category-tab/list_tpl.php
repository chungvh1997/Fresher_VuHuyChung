<div class="well">Danh sách thẻ danh mục '<?=@$category['title']?>' (<?=$pagination->count_item?>)</div>
...
<table class="table table-striped table-bordered text-center">
	<tr>
		<td class="text-left" colspan="14">
			...
			<?php
				$backUrl=preg_replace('(&category_id=\d*)', "", str_replace("?com=category-tab", "?com=category", getCurrentPageURL()));
