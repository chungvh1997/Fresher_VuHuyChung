<div class="well">Thêm / Cập nhật hình ảnh <?php if(@$item!=""): ?><img src="<?=$item['thumbnail']?>"> thuộc <?php endif; ?>sản phẩm '<?=!empty($product) ? implode(" ", array_slice(explode(" ", $product['title']), 0, 3)) . (substr_count($product['title'], " ")>2 ? "..." : "") : ""?>'
</div>
